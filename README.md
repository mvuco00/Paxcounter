...
<p float="left">
<img src="img/pax-device2.jpeg" width="300">
<img src="img/pax-device.jpeg" width="300">
<img src="img/sensor-data.jpeg" width="300">
</p>
...
Target platform must be selected in `platformio.ini`.<br> (We selected *ttgov21new.h*)
...
# Adding BME680 sensor

Sensor needs to be defined in target platform file (in our case that is *ttgov21new.h*)
```cpp
...
Also, add the following line in *platformio.ini* 
```cpp
lib_deps = <...> ${common.lib_deps_sensors}
```

Make sure to connect SDIO of BME680 to GND
